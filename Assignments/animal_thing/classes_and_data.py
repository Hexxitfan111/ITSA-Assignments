...
class animal:
	def __init__(self, name, species, diet, info1, info2, interaction):
		self.name = name
...
class zoo:
	def __init__(self):
		self.locations = [loc0, loc1, loc2, loc3, loc4, loc5, loc6, loc7, loc8, loc9]
...
#Other
facebook = animal("Facebook", "Informationus stealius", "Omnivore", "Facebooks are a very successful form of parasite. They attract a host, and then siphon personal information to sell to other companies",
